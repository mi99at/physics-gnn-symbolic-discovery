...
| `physics_gnn_symbolic_discovery.pdf` | Corrected compiled manuscript | tracked in Git for patch release `v1.0.1` | `7552e711f624f71a17bbc1c41d3eacba0d0af6b2248b84aa6401ef810109c261` |
...
The original DOI-bearing manuscript and release metadata are archived at [Zenodo record 21984786](https://zenodo.org/records/21984786). Patch release `v1.0.1` corrects the reported epoch of the best validation MAE from 31 to 37; the metric value is unchanged. Do not replace a published artifact in place; create a new release version instead.
