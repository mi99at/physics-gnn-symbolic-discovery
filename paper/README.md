...
`physics_gnn_symbolic_discovery.tex` is the submission source aligned with the archived v9 training history and the restored 400-candidate audit. `physics_gnn_symbolic_discovery.pdf` is the visually verified four-page build. The large data arrays and checkpoints are attached to the versioned release listed in `../ARTIFACTS.md`.
